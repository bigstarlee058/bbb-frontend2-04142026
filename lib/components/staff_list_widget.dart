...
class StaffListWidget extends StatelessWidget {
  const StaffListWidget({super.key, required this.height, required this.width, this.oneStaff});

  final double height;
  final double width;
  final Staffs? oneStaff;
  ...
  Widget build(BuildContext context) {
    ...
    return appImage(
      height: height,
      width: width,
      networkImageUrl: oneStaff?.photo ?? "",
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushNamed(context, '/meetOurStaff', arguments: oneStaff);
              },
