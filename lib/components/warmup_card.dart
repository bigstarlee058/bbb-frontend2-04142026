...
import 'package:bbb/components/timer_with_progress.dart';
...
import '../pages/ExerciseView/widgets/notes_slideout.dart';
...
class _WarmupCardState extends State<WarmupCard> with AutomaticKeepAliveClientMixin {
  ...
  void _saveData() {
    ...
    setState(() {
      ...
      exerciseHistoryProvider.saveExercise(widget.subIndex);
  ...
  updateHistoryData() {
    ...
    userData?.updateTodayHistoryData(index, subIndex, {
      'index': index,
      'subIndex': subIndex,
      'reps': reps,
      'weight': weight,
    ...
    return SingleChildScrollView(
      child: Consumer<UserDataProvider>(
        builder: (context, value, child) {
          _isExpanded = "${index}:${subIndex}" == value.currentExpandedItem;
              ...
              children: [
                ExpansionTileItem(
                  tilePadding: EdgeInsets.symmetric(
                    ...
                    vertical: ScreenUtil.verticalScale(0),
                  ),
                  title: Row(
                    children: [
                      Expanded(
                  ...
                  decoration: _showTimer
                      ? const BoxDecoration(
                          ...
                          color: AppColors
                              .warmupColor, //const Color.fromARGB(255, 248, 248, 248),
                        )
                      : BoxDecoration(
