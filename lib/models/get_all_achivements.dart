...
List<AchievementModel> achievementModelFromJson(String str) =>
    List<AchievementModel>.from(json.decode(str).map((x) => AchievementModel.fromJson(x)));

String achievementModelToJson(List<AchievementModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class AchievementId {
  ...
  factory AchievementId.fromJson(Map<String, dynamic> json) => AchievementId(
        ...
        title: json["title"],
        image: json["image"],
        target: json["target"] == null ? null : AchievementModel.fromJson(json["target"]),
        value: json["value"],
...
class Achievement {
  ...
  factory Achievement.fromJson(Map<String, dynamic> json) => Achievement(
        index: json["index"],
        achievementAchievementId: json["achievementId"] == null ? null : AchievementId.fromJson(json["achievementId"]),
        id: json["_id"],
