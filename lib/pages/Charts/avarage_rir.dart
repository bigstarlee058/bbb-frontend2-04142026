...
//
// class AverageRIRGraph extends StatefulWidget {
//   const AverageRIRGraph({super.key});
//
//   @override
//   State<AverageRIRGraph> createState() => _AverageRIRGraphState();
// }
//
// class _AverageRIRGraphState extends State<AverageRIRGraph> {
...
//                   showTitles: true,
//                   interval: monthProvider.maximumValueAvgRIR > 14 ? monthProvider.maximumValueAvgRIR / 5 : 2,
...
//                     return getTitles(value, meta, monthProvider);
//                   }, // This method generates titles for the X-axis
//                 ),
//               ),
...
//               horizontalInterval: monthProvider.maximumValueAvgRIR > 14 ? monthProvider.maximumValueAvgRIR / 5 : 2,
//               show: true,
...
//             }).toList(),
//
//             maxY: monthProvider.maximumValueAvgRIR > 14 ? monthProvider.maximumValueAvgRIR : 14,
