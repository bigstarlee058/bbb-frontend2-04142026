...
class TimeSpentGraph extends StatefulWidget {
  const TimeSpentGraph({super.key});

  @override
  State<TimeSpentGraph> createState() => _BarChartSample7State();
}

class _BarChartSample7State extends State<TimeSpentGraph> {
      ...
      builder: (context, monthProvider, child) {
        return AspectRatio(
          ...
          child: BarChart(BarChartData(
            ...
            titlesData: FlTitlesData(
              ...
              leftTitles: AxisTitles(
                sideTitles: SideTitles(
                  showTitles: true,
                  interval: monthProvider.maximumValueOfTotalTime > 8 ? monthProvider.maximumValueOfTotalTime / 10 : 1,
                  reservedSize: 36, // Space for titles
            ...
            maxY: monthProvider.maximumValueOfTotalTime > 8 ? monthProvider.maximumValueOfTotalTime : 8,
