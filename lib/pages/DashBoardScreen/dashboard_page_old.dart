...
//                                     builder: (context, value, child) {
//                                   List<AchievementModel>? data = dataProvider
//                                       ?.achievementList
//                                       .where((element) => element.achievements!
//                                           .any((e) => e.achieved == true))
//                                       .toList();
//                                   return dataProvider!
...
//                                                                         ?.last;
//                                                                   } else {
//                                                                     int? index1 = data[index].achievements?.indexWhere((element) =>
//                                                                         element
...
//                                                                             .achievements
//                                                                             ?.indexWhere(
//                                                                               (element) => element.achievementAchievementId?.achievementIdId == data2?.achievementAchievementId?.achievementIdId,
//                                                                             );
//
//                                                                         AnimatedDialog
//                                                                             .showAnimatedDialog(
...
//                                                                                 ? 0
//                                                                                 : ((index1! + 1) == (data[index].achievements?.length ?? 0))
//                                                                                     ? index1
//                                                                                     : index1 + 1,
//                                                                           ),
//                                                                         );
...
//                                                                                   height: ScreenUtil.verticalScale(8),
//                                                                                   width: ScreenUtil.verticalScale(8),
//                                                                                   networkImageUrl: "${data2?.achievementAchievementId?.image}".startsWith('https://storage.cloud.google.com/') ? data2?.achievementAchievementId?.image ?? "".replaceFirst('https://storage.cloud.google.com/', 'https://storage.googleapis.com/') : data2?.achievementAchievementId?.image ?? "unknown",
//                                                                                   fit: BoxFit.cover,
