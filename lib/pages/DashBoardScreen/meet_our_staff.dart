  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        margin: EdgeInsets.symmetric(horizontal: ScreenUtil.horizontalScale(9)).copyWith(bottom: ScreenUtil.verticalScale(2.5)),
        child: ButtonWidget(
          text: 'View Details',
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      await launchUrls("https://www.facebook.com");
                                    },
                                    child: Container(
                                      height: ScreenUtil.verticalScale(4),
                                      width: ScreenUtil.verticalScale(4),
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      await launchUrls("https://www.tiktok.com");
                                    },
                                    child: Container(
                                      height: ScreenUtil.verticalScale(4),
                                      width: ScreenUtil.verticalScale(4),
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      await launchUrls("https://www.linkedin.com");
                                    },
                                    child: Container(
                                      height: ScreenUtil.verticalScale(4),
                                      width: ScreenUtil.verticalScale(4),
