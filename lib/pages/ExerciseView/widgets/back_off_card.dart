...
class BackOffSetCard extends StatefulWidget {
  const BackOffSetCard({
    super.key,
    required this.title,
  ...
  @override
  State<BackOffSetCard> createState() => _BackOffSetCardState();
}

class _BackOffSetCardState extends State<BackOffSetCard> with AutomaticKeepAliveClientMixin {
    @override
                ...
                ExpansionTileItem(
                  ...
                  decoration: _showTimer
                      ? const BoxDecoration(
                          ...
                          color: AppColors
                              .backOffSetColor, //const Color.fromARGB(255, 248, 248, 248),
                        )
                      : BoxDecoration(
