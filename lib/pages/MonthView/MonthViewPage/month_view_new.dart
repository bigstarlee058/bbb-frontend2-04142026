...
class _MonthViewNewState extends State<MonthViewNew> {
                ...
                SafeArea(
                  ...
                  child: Consumer<ScrollProvider>(
                    builder: (context, scrollValue, child) {
                      double targetHeight = scrollValue.scrollOffset1 > 40
                          ? ScreenUtil.verticalScale(3.2)
                          : ScreenUtil.verticalScale(5.3);
                                                              ...
                                                              ? GestureDetector(
                                                                  onTap: () {
                                                                    if (monthProvider.currentMonthIndex <
                                                                        monthProvider.monthLocalDataModel.length - 1) {
                                                                      monthProvider.updateCurrentMonthIndex(
                                                                          monthProvider.currentMonthIndex + 1);

                                                                      monthProvider.fetchPastMonth(
                                                                          monthProvider.monthLocalDataModel[
                                                                              monthProvider.currentMonthIndex],
                                                                          context);
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    padding:
                                                                        EdgeInsets.all(ScreenUtil.verticalScale(0.5)),
                                                                    child: Center(
                                                                      child: Text(
                                                                        "Previous",
                                                                        style: TextStyle(
                                                          ...
                                                          Expanded(
                                                            child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  color: AppColors.primaryColor,
                                                                  borderRadius: BorderRadius.circular(10)),
                                                              child: monthProvider.startTime != null &&
                                                          ...
                                                          : SizedBox(
                                                              ...
                                                              child: Center(
                                                                child: Utils.appImage(
                                                                  ...
                                                                  image: monthProvider.monthTitleImage,
                                                                  imageKey: '',
                                                                ),
                                                              ),
                                                            ),
                                              ...
                                              children: List.generate(
                                                ...
                                                (index) => Expanded(
                                                  child: GestureDetector(
                                                    ...
                                                    child: Container(
                                                      padding:
                                                          EdgeInsets.symmetric(vertical: ScreenUtil.verticalScale(2.2)),
                                                      ...
                                                      decoration: BoxDecoration(
                                                          color: index == controller.selectedSection
                                                              ...
                                                              : AppColors.greyColor,
                                                          borderRadius:
                                                              BorderRadius.circular(ScreenUtil.verticalScale(5.5))),
                                                      child: Center(
                                                        child: Text(
                                                          index == 0
                                                              ? "Program"
  ...
  Future<void> continueWorkoutOnTap(BuildContext context) async {
    ...
    bool isRestDay =
        monthProvider!.monthDataModel?.weeks?[(monthProvider!.week ?? 1) - 1].dayList?[index ?? 0].contains("Rest Day");
