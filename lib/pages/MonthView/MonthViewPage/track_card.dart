...
class _WeeklyTrackCardState extends State<WeeklyTrackCard> {
  ...
  Theme filterViewItem(bool initExpanded, String title, MonthProvider monthProvider,
      {required Null Function(bool isExpanded) onExpansionChanged}) {
      ...
      child: ClipRRect(
        ...
        child: ExpansionTile(
          tilePadding: EdgeInsets.symmetric(
            ...
            vertical: ScreenUtil.verticalScale(0.4),
          ),
          expansionAnimationStyle: AnimationStyle(duration: Duration(milliseconds: 300)),
          title: Row(
            children: [
              Expanded(
                child: Text(
          ...
          collapsedBackgroundColor: monthProvider.weekStatuses[mainIndex!] == WeekType.pastWeek ? AppColors.primaryColor : Colors.grey[100],
                                  ...
                                  children: [
                                    ...
                                    Consumer<MonthProvider>(
                                      builder: (context, value, child) {
                                        return (value.weekStatuses[mainIndex!] == WeekType.pastWeek &&
                                                    value.allSplitDayHistoryModel.isEmpty) ||
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: InkWell(
                                      onTap: monthProvider.weekStatuses[mainIndex!] == WeekType.futureWeek
                                          ? null
                                          : () => continueWorkoutOnTap(isRestDay, dataId, index, dayData, context, mainIndex!),
                                      child: Row(
                                                ...
                                                child: Builder(
                                                  builder: (context) {
                                                    ...
                                                    return (isRestDay &&
                                                        ...
                                                        ? pumpRestSelection(index, dayData, context)
                                                        : Text(
  ...
  void continueWorkoutOnTap(bool isRestDay, String dataId, int index, DayDataModel dayData, BuildContext context, int weekIndex) {
  ...
  Widget pumpRestSelection(int index, DayDataModel dayData, BuildContext context) {
    return Row(
      children: [
        GestureDetector(
          onTap: () async {
