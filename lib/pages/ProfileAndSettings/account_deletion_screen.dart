    ...
    return Scaffold(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          "If you'd like to request account deletion please confirm below and a member of our team will contact you and process the request as soon as possible",
                          style: TextStyle(
      ...
      bottomNavigationBar: Padding(
        padding: EdgeInsets.symmetric(
          ...
          vertical: ScreenUtil.horizontalScale(8),
        ),
        child: ButtonWidget(
            text: "I'd like my account deleted",
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AppColors.primaryColor, width: 2), // Outer border
            ),
            child: Padding(
              padding: EdgeInsets.all(
                  2), // Creates space between inner circle and border
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: isSelected
                      ...
                      : Colors.transparent, // Inner circle color
                ),
              ),
            ),
          ),
