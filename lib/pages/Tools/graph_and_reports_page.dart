...
class _GraphAndReportsPageState extends State<GraphAndReportsPage> {
  String _selectExercise = "All Exercises";
  ...
  void _selectItem(String item) {
    _controller.text = item; // Set selected item to the TextField
    setState(() {
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: const ExerciseCompletedGraph(),
                        ),
...
class SearchExerciseField extends StatelessWidget {
  ...
  final TextEditingController controller; // Add a callback for text change
