...
class _TutorialDetailsPageState extends State<TutorialDetailsPage> with TickerProviderStateMixin {
  bool loading = false;
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              dataProvider!.tutorialDataModel!.files!.isNotEmpty && !videoNotInitialized
                                  ? Stack(
                                      children: [
                                        SizedBox(
