                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, countIndex) {
                                          String dataId = monthProvider!.isPumpDay && monthProvider!.isCircuit
                                              ...
                                              : "${monthProvider!.splitType}-${monthProvider!.selectedExercise?.id}-${monthProvider!.exerciseDetailModel?.sId}-$index-$countIndex";

                                          bool isCompleted() {
                                            final val = monthProvider!.historyDataModel.where((element) => element.dataId == dataId);
                                            bool val1 = false;
                                            if (val.isNotEmpty) {
