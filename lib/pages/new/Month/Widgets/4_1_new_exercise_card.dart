...
class _NewExerciseCardState extends State<NewExerciseCard> with AutomaticKeepAliveClientMixin {
  ...
  setData() async {
    ...
    if (expandedDataHistory != null) {
      ...
      weight = int.parse(expandedDataHistory.weight ?? "5");
      reps = int.parse(expandedDataHistory.reps ?? "5");
    } else {
      _weightController = TextEditingController(text: '$weight');
      _repsController = TextEditingController(text: '$reps');
      effort = widget.repsInReverse;
  ...
  Future<void> _saveData() async {
    ...
    final body = {
      ...
      "reps": _repsController.text.toString(),
      ...
      child: Column(
        children: [
          ExpansionTileGroup(
            ...
            spaceBetweenItem: 20,
            onExpansionItemChanged: (idx, isExpand) async {
              setData();
              ...
              ExpansionTileItem(
                ...
                title: Row(
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        if (_timerCompleted || widget.isCompleted) {
                          return InkWell(
                            child: Container(
                ...
                trailing: Row(
                  ...
                  children: [
                    Container(
                      decoration: const BoxDecoration(color: AppColors.primaryColor, borderRadius: BorderRadius.all(Radius.circular(25))),
                      child: Icon(
