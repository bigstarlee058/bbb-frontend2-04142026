...
class MonthProvider extends ChangeNotifier {
  ...
  Map<String, Map<String, dynamic>> filterChartData() {
    ...
    var week = weeks.firstWhere((week) => week['weekNumber'] == this.week,
        orElse: () => {});
    const weekdays = {
      1: "Mon",
      2: "Tue",
  ...
  List<Map<String, dynamic>> processLiftedWeightGraphData(
    ...
    try {
      ...
      if (responseData != null) {
        ...
        if (!val) {
          ...
          pastMonthDataList.add(
              {"monthId": monthDataModelSplit3.id, "monthData": monthData});
